<svelte:head>
    <title>Mast Cell Activation Syndrome (MCAS) | My Example Site | mastcell.help</title>
</svelte:head>
...
<li><p><strong>Treatment</strong>: The primary treatment for MCAS involves avoiding triggers and using medications to control symptoms. Medications may include antihistamines, mast cell stabilizers, and sometimes corticosteroids. Identifying and avoiding specific triggers is also an important part of managing the condition.</p></li>
</ul>
