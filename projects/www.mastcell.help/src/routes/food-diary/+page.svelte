<svelte:head>
    <title>Food diary | My Example Site | mastcell.help</title>
</svelte:head>
...
<li><p><strong>Add Notes</strong>: Include any relevant notes about your meals, such as how you felt while eating (e.g., hungry, stressed, bored) and any digestive or physical reactions afterward.</p></li>
<li><p><strong>Review and Analyze</strong>: After maintaining the food diary for your chosen duration, review and analyze your entries. Look for patterns, such as overeating at certain times or consuming too much of a particular type of food. Use this information to make informed decisions about your diet and identify areas for improvement.</p></li>
</ul>
