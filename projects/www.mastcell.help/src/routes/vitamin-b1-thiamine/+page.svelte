<svelte:head>
    <title>Vitamin B1 = Thiamine | My Example
...
<p>Vitamin B1, also known as thiamine, is one of the eight B-vitamins
essential for various bodily functions. Thiamine plays a crucial role in
energy metabolism, as it is a coenzyme necessary for the conversion of
carbohydrates into energy. It also helps maintain proper functioning of
...
that it is not stored in the body, and excess amounts are excreted in
the urine. Therefore, it needs to be regularly consumed in the diet to
meet the body’s requirements.</p>
<p>Thiamine deficiency can lead to a condition known as beriberi, which
is characterized by symptoms such as muscle weakness, nerve damage, and
difficulty with basic bodily functions. In severe cases, it can be
life-threatening. To prevent thiamine deficiency, it’s important to
maintain a balanced diet that includes foods rich in vitamin B1.</p>
