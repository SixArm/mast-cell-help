...
<li><p><strong>Glutathione Depletion</strong>: Glutathione is an important antioxidant that helps protect cells from oxidative stress. In ferroptosis, there is a depletion of glutathione, which reduces the cell’s ability to neutralize ROS and protect against lipid peroxidation.</p></li>
<li><p><strong>Glutathione Peroxidase 4 (GPX4)</strong>: GPX4 is an enzyme that plays a key role in protecting cells from lipid peroxidation. In ferroptosis, GPX4 activity is inhibited or reduced, contributing to the accumulation of lipid peroxides.</p></li>
<li><p><strong>Inhibition of System Xc-</strong>: System Xc- is a cellular transporter that imports cystine (a precursor to glutathione) into cells in exchange for glutamate. Inhibiting this system can reduce the availability of cystine and glutathione, further promoting ferroptosis.</p></li>
</ul>
