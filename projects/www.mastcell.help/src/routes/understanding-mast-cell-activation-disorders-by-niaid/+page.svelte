<svelte:head>
    <title>Understanding Mast Cell Activation Disorders - By NIAID | My Example Site | mastcell.help</title>
</svelte:head>
...
<p>In the course of their work, the scientists had identified a different family with bad allergies and joint problems, including overly flexible joints. Multiple family members had these distinct symptoms, suggesting a genetic disorder.</p>
<p>Interestingly, the scientists found that the affected family members all had a high blood level of tryptase, a marker associated with mast cell activation. It appeared that patients were inheriting tryptase elevations along with their symptoms.</p>
<p>They have since identified other families with inherited mast cell activation disorders.</p>
