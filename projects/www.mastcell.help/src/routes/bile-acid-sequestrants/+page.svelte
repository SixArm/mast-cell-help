<svelte:head>
    <title>Bile acid sequestrants | My Example
...
<p>Bile acid sequestrants, also known as bile acid-binding resins or
simply bile sequestrants, are a class of medications primarily used to
lower high levels of cholesterol in the blood. They work by binding to
...
(hypercholesterolemia). High LDL cholesterol is a risk factor for
atherosclerosis and coronary heart disease. These medications can also
be used in combination with other cholesterol-lowering drugs, such as
statins, to achieve better control of cholesterol levels.</p>
<p>Common Bile Acid Sequestrants: There are a few different bile acid
sequestrants available, including Cholestyramine (a.k.a. brand name
Questran), Colesevelam (a.k.a. brand name Welchol), and Colestipol
(a.k.a. brand name Colestid).</p>
<p>Dosing and Administration: Bile acid sequestrants are typically taken
orally in the form of a powder or tablet. They are usually mixed with
water or another liquid and should be taken with meals to improve their
...
interventions have not been sufficient to lower cholesterol levels or
when statins are not an option. It’s important to work closely with your
healthcare provider to determine the most appropriate treatment for your
specific situation and to monitor your response to treatment.</p>
