<svelte:head>
    <title>Soy allergy ingredient names | mastcell.help | mastcell.help</title>
</svelte:head>

<div class="prose">

<h1 id="soy-allergy-ingredient-names">Soy allergy ingredient names</h1>
<p>If you’re doing an elimination diet, or you have a soy allergy, then check food labels for ingredient names that may be related to soy derivatives. Credit: Soy Allergy Board.</p>
<p>Alkyd Resin.
Alkyl Chlorides.
Amylase.
Annatto.
...
Yuba.
Zanthan (and spelling variations).</p>
